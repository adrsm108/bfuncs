...
while(true){
if((i__4737__auto___27538 < len__4736__auto___27536)){
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq27404){
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq27412){
var G__27413 = cljs.core.first(seq27412);
var seq27412__$1 = cljs.core.next(seq27412);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27413,seq27412__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq27417){
var G__27418 = cljs.core.first(seq27417);
var seq27417__$1 = cljs.core.next(seq27417);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27418,seq27417__$1);
}));
...
var G__27554 = (i__4737__auto___27552 + (1));
i__4737__auto___27552 = G__27554;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq27427){
var G__27428 = cljs.core.first(seq27427);
var seq27427__$1 = cljs.core.next(seq27427);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27428,seq27427__$1);
}));
...
var init = (function (){var G__27442 = kind;
var G__27442__$1 = (((G__27442 instanceof cljs.core.Keyword))?G__27442.fqn:null);
switch (G__27442__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27442__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq27438){
var G__27439 = cljs.core.first(seq27438);
var seq27438__$1 = cljs.core.next(seq27438);
var G__27440 = cljs.core.first(seq27438__$1);
var seq27438__$2 = cljs.core.next(seq27438__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27439,G__27440,seq27438__$2);
}));
...
var iter__4529__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__27505(s__27506){
return (new cljs.core.LazySeq(null,(function (){
var s__27506__$1 = s__27506;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__27506__$1);
if(temp__5735__auto__){
var s__27506__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27506__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__27506__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__27508 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__27507 = (0);
while(true){
if((i__27507 < size__4528__auto__)){
var vec__27516 = cljs.core._nth(c__4527__auto__,i__27507);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27516,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27516,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__27508,id);

var G__27584 = (i__27507 + (1));
i__27507 = G__27584;
continue;
} else {
var G__27585 = (i__27507 + (1));
i__27507 = G__27585;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27508),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__27505(cljs.core.chunk_rest(s__27506__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27508),null);
}
} else {
var vec__27520 = cljs.core.first(s__27506__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__27505(cljs.core.rest(s__27506__$2)));
} else {
var G__27586 = cljs.core.rest(s__27506__$2);
s__27506__$1 = G__27586;
continue;
}
}
} else {
