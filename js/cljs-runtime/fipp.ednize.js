...
var fipp$ednize$IEdn$_edn$dyn_39163 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_39163(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function fipp$ednize$edn_$_iter__39119(s__39120){
...
var c__4527__auto__ = cljs.core.chunk_first(s__39120__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__39122 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__39121 = (0);
while(true){
if((i__39121 < size__4528__auto__)){
var k = cljs.core._nth(c__4527__auto__,i__39121);
cljs.core.chunk_append(b__39122,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__39173 = (i__39121 + (1));
i__39121 = G__39173;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39122),fipp$ednize$edn_$_iter__39119(cljs.core.chunk_rest(s__39120__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39122),null);
}
} else {
var k = cljs.core.first(s__39120__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__39119(cljs.core.rest(s__39120__$2)));
}
} else {
return null;
}
