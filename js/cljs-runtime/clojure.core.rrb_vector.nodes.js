...
var G__39314 = (root.arr[(slc - (1))]);
var G__39315 = (shift - (5));
var G__39316 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__39314;
shift = G__39315;
cnt = G__39316;
continue;
...
if((!(r_QMARK_))){
var rngs_39329 = clojure.core.rrb_vector.nodes.node_ranges(parent);
var rng0_39330 = (rngs_39329[(0)]);
var new_rngs_39331 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_39332 = (rngs_39329[(32)]);
cljs.core.array_copy(rngs_39329,(1),new_rngs_39331,(0),(lim_39332 - (1)));

var i_39333 = (0);
while(true){
if((i_39333 < lim_39332)){
(new_rngs_39331[i_39333] = ((new_rngs_39331[i_39333]) - rng0_39330));

var G__39335 = (i_39333 + (1));
i_39333 = G__39335;
continue;
} else {
}
...
(new_rngs_39331[(32)] = ((rngs_39329[(32)]) - (1)));

(new_rngs_39331[((rngs_39329[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_39331);
} else {
}
...
while(true){
if((i_39339 <= li)){
(new_rngs[i_39339] = ((new_rngs[(i_39339 - (1))]) + step));

var G__39341 = (i_39339 + (1));
i_39339 = G__39341;
continue;
} else {
}
...
while(true){
if((i_39348 <= li)){
(new_rngs[i_39348] = ((rngs[i_39348]) - d));

var G__39349 = (i_39348 + (1));
i_39348 = G__39349;
continue;
} else {
}
...
while(true){
if((j_39354 <= i)){
(rngs[j_39354] = r_39355);

var G__39356 = (j_39354 + (1));
var G__39357 = (r_39355 + step);
j_39354 = G__39356;
r_39355 = G__39357;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__39298 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__39298[(0)] = node.arr.length);
...
var arr_39358__$1 = arr;
var shift_39359__$1 = shift;
while(true){
if((shift_39359__$1 === (5))){
if((!(reg_QMARK_))){
(arr_39358__$1[(32)] = rngs);
} else {
}

(arr_39358__$1[(0)] = node);
} else {
var a_39392 = (new Array(len));
var e_39393 = cljs.core.__GT_VectorNode(null,a_39392);
(arr_39358__$1[(0)] = e_39393);
...
var G__39395 = a_39392;
var G__39396 = (shift_39359__$1 - (5));
arr_39358__$1 = G__39395;
shift_39359__$1 = G__39396;
continue;
}
break;
}
...
var cret = (((shift === (5)))?cljs.core.__GT_VectorNode(null,tail):(function (){var G__39304 = (arr[(li - (1))]);
var G__39305 = (shift - (5));
var G__39306 = ((clojure.core.rrb_vector.nodes.regular_QMARK_(node))?cljs.core.mod(cnt,((1) << shift)):(function (){var li__$1 = ((rngs[(32)]) - (1));
if((li__$1 > (0))){
...
var G__39307 = tail;
return (clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4 ? clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4(G__39304,G__39305,G__39306,G__39307) : clojure.core.rrb_vector.nodes.fold_tail.call(null,G__39304,G__39305,G__39306,G__39307));
})());
