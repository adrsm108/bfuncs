shadow$provide.module$node_modules$d3_contour$dist$d3_contour=function(global$jscomp$0,require,module,exports$jscomp$0){(function(global,factory){"object"===typeof exports$jscomp$0&&"undefined"!==typeof module?factory(exports$jscomp$0,require("module$node_modules$d3_array$dist$d3_array")):"function"===typeof define&&define.amd?define(["exports","d3-array"],factory):(global=global||self,factory(global.d3=global.d3||{},global.d3))})(this,function(exports,d3Array){function ascending(a,b){return a-b}
...
j>=r&&(j>=w&&(sr-=source.data[i+(j-w)*n]),target.data[i+(j-r)*n]=sr/Math.min(j+1,m-1+w-j,w))}function defaultX(d){return d[0]}function defaultY(d){return d[1]}function defaultWeight(){return 1}var slice=Array.prototype.slice,constant=x=>()=>x,cases=[[],[[[1,1.5],[.5,1]]],[[[1.5,1],[1,1.5]]],[[[1.5,1],[.5,1]]],[[[1,.5],[1.5,1]]],[[[1,1.5],[.5,1]],[[1,.5],[1.5,1]]],[[[1,.5],[1,1.5]]],[[[1,.5],[.5,1]]],[[[.5,1],[1,.5]]],[[[1,1.5],[1,.5]]],[[[.5,1],[1,.5]],[[1.5,1],[1,1.5]]],[[[1.5,1],[1,.5]]],[[[.5,
1],[1.5,1]]],[[[1,1.5],[1.5,1]]],[[[.5,1],[1,1.5]]],[]];exports.contourDensity=function(){function density(data$jscomp$0){var values0=new Float32Array(n*m),values1=new Float32Array(n*m);data$jscomp$0.forEach(function(d,i,data){var xi=+x(d,i,data)+o>>k,yi=+y(d,i,data)+o>>k;d=+weight(d,i,data);0<=xi&&xi<n&&0<=yi&&yi<m&&(values0[xi+yi*n]+=d)});blurX({width:n,height:m,data:values0},{width:n,height:m,data:values1},r>>k);blurY({width:n,height:m,data:values1},{width:n,height:m,data:values0},r>>k);blurX({width:n,
height:m,data:values0},{width:n,height:m,data:values1},r>>k);blurY({width:n,height:m,data:values1},{width:n,height:m,data:values0},r>>k);blurX({width:n,height:m,data:values0},{width:n,height:m,data:values1},r>>k);blurY({width:n,height:m,data:values1},{width:n,height:m,data:values0},r>>k);data$jscomp$0=threshold(values0);Array.isArray(data$jscomp$0)||(values1=d3Array.max(values0),data$jscomp$0=d3Array.tickStep(0,values1,data$jscomp$0),data$jscomp$0=d3Array.range(0,Math.floor(values1/data$jscomp$0)*
data$jscomp$0,data$jscomp$0),data$jscomp$0.shift());return contours().thresholds(data$jscomp$0).size([n,m])(values0).map(transform)}function transform(geometry){geometry.value*=Math.pow(2,-2*k);geometry.coordinates.forEach(transformPolygon);return geometry}function transformPolygon(coordinates){coordinates.forEach(transformRing)}function transformRing(coordinates){coordinates.forEach(transformPoint)}function transformPoint(coordinates){coordinates[0]=coordinates[0]*Math.pow(2,k)-o;coordinates[1]=
coordinates[1]*Math.pow(2,k)-o}function resize(){o=3*r;n=dx+2*o>>k;m=dy+2*o>>k;return density}var x=defaultX,y=defaultY,weight=defaultWeight,dx=960,dy=500,r=20,k=2,o=3*r,n=dx+2*o>>k,m=dy+2*o>>k,threshold=constant(20);density.x=function(_){return arguments.length?(x="function"===typeof _?_:constant(+_),density):x};density.y=function(_){return arguments.length?(y="function"===typeof _?_:constant(+_),density):y};density.weight=function(_){return arguments.length?(weight="function"===typeof _?_:constant(+_),
density):weight};density.size=function(_){if(!arguments.length)return[dx,dy];var _0=+_[0],_1=+_[1];if(!(0<=_0&&0<=_1))throw Error("invalid size");return dx=_0,dy=_1,resize()};density.cellSize=function(_){if(!arguments.length)return 1<<k;if(!(1<=(_=+_)))throw Error("invalid cell size");return k=Math.floor(Math.log(_)/Math.LN2),resize()};density.thresholds=function(_){return arguments.length?(threshold="function"===typeof _?_:Array.isArray(_)?constant(slice.call(_)):constant(_),density):threshold};
density.bandwidth=function(_){if(!arguments.length)return Math.sqrt(r*(r+1));if(!(0<=(_=+_)))throw Error("invalid bandwidth");return r=Math.round((Math.sqrt(4*_*_+1)-1)/2),resize()};return density};exports.contours=contours;Object.defineProperty(exports,"__esModule",{value:!0})})}
