...
var G__27600 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27600;
continue;
} else {
return ch;
...
var vec__27571 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27571,(0),null);
return (match === s);
});
...
args__4742__auto__.push((arguments[i__4737__auto___27627]));

var G__27629 = (i__4737__auto___27627 + (1));
i__4737__auto___27627 = G__27629;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27593){
...
return (function() { 
var G__27636__delegate = function (rdr,_){
...
var G__27636 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27637__i = 0, G__27637__a = new Array(arguments.length -  1);
while (G__27637__i < G__27637__a.length) {G__27637__a[G__27637__i] = arguments[G__27637__i + 1]; ++G__27637__i;}
  _ = new cljs.core.IndexedSeq(G__27637__a,0,null);
} 
return G__27636__delegate.call(this,rdr,_);};
G__27636.cljs$lang$maxFixedArity = 1;
G__27636.cljs$lang$applyTo = (function (arglist__27638){
var rdr = cljs.core.first(arglist__27638);
var _ = cljs.core.rest(arglist__27638);
return G__27636__delegate(rdr,_);
});
