...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38714 = c;
var G__38714__$1 = (((G__38714 == null))?null:G__38714.prototype);
if((G__38714__$1 == null)){
return null;
} else {
return G__38714__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38716 = c;
var G__38716__$1 = (((G__38716 == null))?null:G__38716.prototype);
if((G__38716__$1 == null)){
return null;
} else {
return G__38716__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__38736 = c;
var G__38736__$1 = (((G__38736 == null))?null:G__38736.constructor);
if((G__38736__$1 == null)){
return null;
} else {
return G__38736__$1.displayName;
}
})();
...
var G__38737 = c;
var G__38737__$1 = (((G__38737 == null))?null:G__38737.constructor);
if((G__38737__$1 == null)){
return null;
} else {
return G__38737__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38738 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38739 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38739);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38738);
}});
...
var c = this;
var G__38759_38928 = goog.object.get(c,"cljsRatom");
if((G__38759_38928 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38759_38928);
}
...
var renders_38932 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38933 = cljs.core.first(cljs.core.vals(renders_38932));
...
if((cljs.core.count(renders_38932) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38932))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38933)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38933], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38766 = o;
goog.object.set(G__38766,cljs.core.name(k),v);
...
while (G__38950__i < G__38950__a.length) {G__38950__a[G__38950__i] = arguments[G__38950__i + 0]; ++G__38950__i;}
  args = new cljs.core.IndexedSeq(G__38950__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__38847 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38848 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38848);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38847);
}});
...
var vec__38861 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38861,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38861,(1),null);
...
var G__38868 = goog.object.get(reagent_state,"cljsRatom");
if((G__38868 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38868);
}
});
}),[]);
