...
var G__38948 = o;
goog.object.set(G__38948,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__39073__delegate = function (args){
...
while (G__39074__i < G__39074__a.length) {G__39074__a[G__39074__i] = arguments[G__39074__i + 0]; ++G__39074__i;}
  args = new cljs.core.IndexedSeq(G__39074__a,0,null);
} 
return G__39073__delegate.call(this,args);};
G__39073.cljs$lang$maxFixedArity = 0;
G__39073.cljs$lang$applyTo = (function (arglist__39075){
var args = cljs.core.seq(arglist__39075);
return G__39073__delegate(args);
});
...
var G__38959 = o;
goog.object.set(G__38959,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = cljs.core.seq(arglist__39087);
...
var G__38967 = props;
var G__38967__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38967,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38967);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38967__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38971 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38971,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38971;
}
})(),id_class);
...
var G__38972 = (cljs.core.count(argv) - first_child);
switch (G__38972) {
case (0):
...
var vec__38973 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38973,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38973,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38973,(2),null);
...
var temp__5739__auto___39132 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39132 == null)){
} else {
var key_39133 = temp__5739__auto___39132;
(jsprops.key = key_39133);
}
...
var temp__5739__auto___39138 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39138 == null)){
} else {
var key_39139 = temp__5739__auto___39138;
(jsprops.key = key_39139);
}
...
var temp__5739__auto___39144 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___39144 == null)){
} else {
var key_39145 = temp__5739__auto___39144;
(jsprops.key = key_39145);
}
...
var temp__5739__auto___39149 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39149 == null)){
} else {
var key_39150 = temp__5739__auto___39149;
(jsprops.key = key_39150);
}
...
var temp__5739__auto___39156 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39156 == null)){
} else {
var key_39158 = temp__5739__auto___39156;
(jsprops.key = key_39158);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39001_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39001_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39005 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39005,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39005,(1),null);
...
break;
default:
var G__39179 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39180 = compiler;
v = G__39179;
compiler = G__39180;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39045 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39045 = (function (opts,id,fn_to_element,meta39046){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39045.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39047,meta39046__$1){
var self__ = this;
var _39047__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39045(self__.opts,self__.id,self__.fn_to_element,meta39046__$1));
}));

(reagent.impl.template.t_reagent$impl$template39045.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39047){
var self__ = this;
var _39047__$1 = this;
return self__.meta39046;
}));

(reagent.impl.template.t_reagent$impl$template39045.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39045.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39045.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39045.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39045.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta39046","meta39046",212366748,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39045.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39045.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39045");

(reagent.impl.template.t_reagent$impl$template39045.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template39045");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39045.
 */
reagent.impl.template.__GT_t_reagent$impl$template39045 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39045(opts__$1,id__$1,fn_to_element__$1,meta39046){
return (new reagent.impl.template.t_reagent$impl$template39045(opts__$1,id__$1,fn_to_element__$1,meta39046));
});

}

return (new reagent.impl.template.t_reagent$impl$template39045(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
