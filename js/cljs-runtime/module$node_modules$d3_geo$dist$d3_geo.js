...
z0*lambda;var cy=z0*x-x0$jscomp$0*phi,cz=x0$jscomp$0*lambda-y0$jscomp$0*x,m=hypot(cosPhi,cy,cz),w=asin(m);m=m&&-w/m;X2.add(m*cosPhi);Y2.add(m*cy);Z2.add(m*cz);W1+=w;X1+=w*(x0$jscomp$0+(x0$jscomp$0=x));Y1+=w*(y0$jscomp$0+(y0$jscomp$0=lambda));Z1+=w*(z0+(z0=phi));centroidPointCartesian(x0$jscomp$0,y0$jscomp$0,z0)}function constant(x){return function(){return x}}function compose$jscomp$0(a,b){function compose(x,y){return x=a(x,y),b(x[0],x[1])}a.invert&&b.invert&&(compose.invert=function(x,y){return x=
b.invert(x,y),x&&a.invert(x[0],x[1])});return compose}function rotationIdentity(lambda,phi){return[abs(lambda)>pi?lambda+Math.round(-lambda/tau)*tau:lambda,phi]}function rotateRadians(deltaLambda,deltaPhi,deltaGamma){return(deltaLambda%=tau)?deltaPhi||deltaGamma?compose$jscomp$0(rotationLambda(deltaLambda),rotationPhiGamma(deltaPhi,deltaGamma)):rotationLambda(deltaLambda):deltaPhi||deltaGamma?rotationPhiGamma(deltaPhi,deltaGamma):rotationIdentity}function forwardRotationLambda(deltaLambda){return function(lambda,
phi){return lambda+=deltaLambda,[lambda>pi?lambda-tau:lambda<-pi?lambda+tau:lambda,phi]}}function rotationLambda(deltaLambda){var rotation=forwardRotationLambda(deltaLambda);rotation.invert=forwardRotationLambda(-deltaLambda);return rotation}function rotationPhiGamma(deltaPhi,deltaGamma){function rotation(lambda,phi){var cosPhi=cos(phi),x=cos(lambda)*cosPhi;lambda=sin(lambda)*cosPhi;phi=sin(phi);cosPhi=phi*cosDeltaPhi+x*sinDeltaPhi;return[atan2(lambda*cosDeltaGamma-cosPhi*sinDeltaGamma,x*cosDeltaPhi-
...
clipBuffer(),ringSink=clipLine(ringBuffer),polygonStarted=!1,polygon,segments,ring,clip={point:point$jscomp$0,lineStart,lineEnd,polygonStart:function(){clip.point=pointRing;clip.lineStart=ringStart;clip.lineEnd=ringEnd;segments=[];polygon=[]},polygonEnd:function(){clip.point=point$jscomp$0;clip.lineStart=lineStart;clip.lineEnd=lineEnd;segments=d3Array.merge(segments);var startInside=polygonContains(polygon,start);segments.length?(polygonStarted||(sink.polygonStart(),polygonStarted=!0),clipRejoin(segments,
compareIntersection,startInside,interpolate,sink)):startInside&&(polygonStarted||(sink.polygonStart(),polygonStarted=!0),sink.lineStart(),interpolate(null,null,1,sink),sink.lineEnd());polygonStarted&&(sink.polygonEnd(),polygonStarted=!1);segments=polygon=null},sphere:function(){sink.polygonStart();sink.lineStart();interpolate(null,null,1,sink);sink.lineEnd();sink.polygonEnd()}};return clip}}function validSegment(segment){return 1<segment.length}function compareIntersection(a,b){return(0>(a=a.x)[0]?
a[1]-halfPi-1E-6:halfPi-a[1])-(0>(b=b.x)[0]?b[1]-halfPi-1E-6:halfPi-b[1])}function clipCircle(radius){function visible(lambda,phi){return cos(lambda)*cos(phi)>cr}function intersect(a,b,two){var pa=cartesian(a),pb=cartesian(b),n1=[1,0,0];pb=cartesianCross(pa,pb);var n2n2=cartesianDot(pb,pb);pa=pb[0];var determinant=n2n2-pa*pa;if(!determinant)return!two&&a;n2n2=cr*n2n2/determinant;determinant=-cr*pa/determinant;pa=cartesianCross(n1,pb);n1=cartesianScale(n1,n2n2);pb=cartesianScale(pb,determinant);cartesianAddInPlace(n1,
pb);pb=cartesianDot(n1,pa);n2n2=cartesianDot(pa,pa);determinant=pb*pb-n2n2*(cartesianDot(n1,n1)-1);if(!(0>determinant)){var t=sqrt(determinant);determinant=cartesianScale(pa,(-pb-t)/n2n2);cartesianAddInPlace(determinant,n1);determinant=spherical(determinant);if(!two)return determinant;two=a[0];var lambda1=b[0];a=a[1];b=b[1];if(lambda1<two){var z=two;two=lambda1;lambda1=z}var delta=lambda1-two,polar=1E-6>abs(delta-pi);!polar&&b<a&&(z=a,a=b,b=z);if(polar||1E-6>delta?polar?0<a+b^determinant[1]<(1E-6>
abs(determinant[0]-two)?a:b):a<=determinant[1]&&determinant[1]<=b:delta>pi^(two<=determinant[0]&&determinant[0]<=lambda1))return b=cartesianScale(pa,(-pb+t)/n2n2),cartesianAddInPlace(b,n1),[determinant,spherical(b)]}}function code$jscomp$0(lambda,phi){var r=smallRadius?radius:pi-radius,code=0;lambda<-r?code|=1:lambda>r&&(code|=2);phi<-r?code|=4:phi>r&&(code|=8);return code}var cr=cos(radius),delta$jscomp$0=6*radians,smallRadius=0<cr,notHemisphere=1E-6<abs(cr);return clip(visible,function(stream){var point0,
c0,v0,v00,clean;return{lineStart:function(){v00=v0=!1;clean=1},point:function(lambda,phi){var point1=[lambda,phi],v=visible(lambda,phi);phi=smallRadius?v?0:code$jscomp$0(lambda,phi):v?code$jscomp$0(lambda+(0>lambda?pi:-pi),phi):0;!point0&&(v00=v0=v)&&stream.lineStart();v!==v0&&(lambda=intersect(point0,point1),!lambda||pointEqual(point0,lambda)||pointEqual(point1,lambda))&&(point1[2]=1);if(v!==v0)clean=0,v?(stream.lineStart(),lambda=intersect(point1,point0),stream.point(lambda[0],lambda[1])):(lambda=
intersect(point0,point1),stream.point(lambda[0],lambda[1],2),stream.lineEnd()),point0=lambda;else if(notHemisphere&&point0&&smallRadius^v){var t;phi&c0||!(t=intersect(point1,point0,!0))||(clean=0,smallRadius?(stream.lineStart(),stream.point(t[0][0],t[0][1]),stream.point(t[1][0],t[1][1]),stream.lineEnd()):(stream.point(t[1][0],t[1][1]),stream.lineEnd(),stream.lineStart(),stream.point(t[0][0],t[0][1],3)))}!v||point0&&pointEqual(point0,point1)||stream.point(point1[0],point1[1]);point0=point1;v0=v;c0=
phi},lineEnd:function(){v0&&stream.lineEnd();point0=null},clean:function(){return clean|(v00&&v0)<<1}}},function(from,to,direction,stream){circleStream(stream,radius,delta$jscomp$0,direction,from,to)},smallRadius?[0,-radius]:[-pi,radius-pi])}function clipLine(a,b,x0,y0,x1,y1){var ax=a[0],ay=a[1],t0=0,t1=1,dx=b[0]-ax,dy=b[1]-ay;x0-=ax;if(dx||!(0<x0)){x0/=dx;if(0>dx){if(x0<t0)return;x0<t1&&(t1=x0)}else if(0<dx){if(x0>t1)return;x0>t0&&(t0=x0)}x0=x1-ax;if(dx||!(0>x0)){x0/=dx;if(0>dx){if(x0>t1)return;
x0>t0&&(t0=x0)}else if(0<dx){if(x0<t0)return;x0<t1&&(t1=x0)}x0=y0-ay;if(dy||!(0<x0)){x0/=dy;if(0>dy){if(x0<t0)return;x0<t1&&(t1=x0)}else if(0<dy){if(x0>t1)return;x0>t0&&(t0=x0)}x0=y1-ay;if(dy||!(0>x0)){x0/=dy;if(0>dy){if(x0>t1)return;x0>t0&&(t0=x0)}else if(0<dy){if(x0<t0)return;x0<t1&&(t1=x0)}0<t0&&(a[0]=ax+t0*dx,a[1]=ay+t0*dy);1>t1&&(b[0]=ax+t1*dx,b[1]=ay+t1*dy);return!0}}}}}function clipRectangle(x0,y0,x1,y1){function interpolate(from,to,direction,stream){var a=0,a1=0;if(null==from||(a=corner(from,
direction))!==(a1=corner(to,direction))||0>comparePoint(from,to)^0<direction){do stream.point(0===a||3===a?x0:x1,1<a?y1:y0);while((a=(a+direction+4)%4)!==a1)}else stream.point(to[0],to[1])}function corner(p,direction){return 1E-6>abs(p[0]-x0)?0<direction?0:3:1E-6>abs(p[0]-x1)?0<direction?2:1:1E-6>abs(p[1]-y0)?0<direction?1:0:0<direction?3:2}function compareIntersection(a,b){return comparePoint(a.x,b.x)}function comparePoint(a,b){var ca=corner(a,1),cb=corner(b,1);return ca!==cb?ca-cb:0===ca?b[1]-a[1]:
1===ca?a[0]-b[0]:2===ca?a[1]-b[1]:b[0]-a[0]}return function(stream){function point$jscomp$0(x,y){x0<=x&&x<=x1&&y0<=y&&y<=y1&&activeStream.point(x,y)}function linePoint(x,y){var v=x0<=x&&x<=x1&&y0<=y&&y<=y1;polygon&&ring$jscomp$0.push([x,y]);if(first)x__=x,y__=y,v__=v,first=!1,v&&(activeStream.lineStart(),activeStream.point(x,y));else if(v&&v_)activeStream.point(x,y);else{var a=[x_=Math.max(-1E9,Math.min(1E9,x_)),y_=Math.max(-1E9,Math.min(1E9,y_))],b=[x=Math.max(-1E9,Math.min(1E9,x)),y=Math.max(-1E9,
Math.min(1E9,y))];clipLine(a,b,x0,y0,x1,y1)?(v_||(activeStream.lineStart(),activeStream.point(a[0],a[1])),activeStream.point(b[0],b[1]),v||activeStream.lineEnd(),clean=!1):v&&(activeStream.lineStart(),activeStream.point(x,y),clean=!1)}x_=x;y_=y;v_=v}var activeStream=stream,bufferStream=clipBuffer(),segments,polygon,ring$jscomp$0,x__,y__,v__,x_,y_,v_,first,clean,clipStream={point:point$jscomp$0,lineStart:function(){clipStream.point=linePoint;polygon&&polygon.push(ring$jscomp$0=[]);first=!0;v_=!1;x_=
y_=NaN},lineEnd:function(){segments&&(linePoint(x__,y__),v__&&v_&&bufferStream.rejoin(),segments.push(bufferStream.result()));clipStream.point=point$jscomp$0;v_&&activeStream.lineEnd()},polygonStart:function(){activeStream=bufferStream;segments=[];polygon=[];clean=!0},polygonEnd:function(){for(var startInside,i=startInside=0,n=polygon.length;i<n;++i){var ring=polygon[i],j=1,m=ring.length,point=ring[0],b0=point[0];for(point=point[1];j<m;++j){var a0=b0;var a1=point;point=ring[j];b0=point[0];point=point[1];
a1<=y1?point>y1&&(b0-a0)*(y1-a1)>(point-a1)*(x0-a0)&&++startInside:point<=y1&&(b0-a0)*(y1-a1)<(point-a1)*(x0-a0)&&--startInside}}i=clean&&startInside;n=(segments=d3Array.merge(segments)).length;if(i||n)stream.polygonStart(),i&&(stream.lineStart(),interpolate(null,null,1,stream),stream.lineEnd()),n&&clipRejoin(segments,compareIntersection,startInside,interpolate,stream),stream.polygonEnd();activeStream=stream;segments=polygon=ring$jscomp$0=null}};return clipStream}}function lengthLineEnd(){lengthStream.point=
...
projection.reflectX=function(_){return arguments.length?(sx=_?-1:1,recenter()):0>sx};projection.reflectY=function(_){return arguments.length?(sy=_?-1:1,recenter()):0>sy};projection.precision=function(_){if(arguments.length){var JSCompiler_temp=projectTransform;var delta2=delta2$jscomp$0=_*_;JSCompiler_temp=(projectResample=+delta2?resample$1(JSCompiler_temp,delta2):resampleNone(JSCompiler_temp),reset())}else JSCompiler_temp=sqrt(delta2$jscomp$0);return JSCompiler_temp};projection.fitExtent=function(extent,
object){return fitExtent(projection,extent,object)};projection.fitSize=function(size,object){return fitExtent(projection,[[0,0],size],object)};projection.fitWidth=function(width,object){return fitWidth(projection,width,object)};projection.fitHeight=function(height,object){return fitHeight(projection,height,object)};return function(){project=projectAt.apply(this,arguments);projection.invert=project.invert&&invert;return recenter()}}function conicProjection(projectAt){var phi0=0,phi1=pi/3,m=projectionMutator(projectAt);
projectAt=m(phi0,phi1);projectAt.parallels=function(_){return arguments.length?m(phi0=_[0]*radians,phi1=_[1]*radians):[phi0*degrees,phi1*degrees]};return projectAt}function cylindricalEqualAreaRaw(phi0){function forward(lambda,phi){return[lambda*cosPhi0,sin(phi)/cosPhi0]}var cosPhi0=cos(phi0);forward.invert=function(x,y){return[x/cosPhi0,asin(y*cosPhi0)]};return forward}function conicEqualAreaRaw(y0,y1){function project(x,y){y=sqrt(c-2*n*sin(y))/n;return[y*sin(x*=n),r0-y*cos(x)]}var sy0=sin(y0),n=
(sy0+sin(y1))/2;if(1E-6>abs(n))return cylindricalEqualAreaRaw(y0);var c=1+sy0*(2*n-sy0),r0=sqrt(c)/n;project.invert=function(x,y){y=r0-y;var l=atan2(x,abs(y))*sign$jscomp$0(y);0>y*n&&(l-=pi*sign$jscomp$0(x)*sign$jscomp$0(y));return[l/n,asin((c-(x*x+y*y)*n*n)/(2*n))]};return project}function conicEqualArea(){return conicProjection(conicEqualAreaRaw).scale(155.424).center([0,33.6442])}function albers(){return conicEqualArea().parallels([29.5,45.5]).scale(1070).translate([480,250]).rotate([96,0]).center([-.6,
38.7])}function multiplex(streams){var n=streams.length;return{point:function(x,y){for(var i=-1;++i<n;)streams[i].point(x,y)},sphere:function(){for(var i=-1;++i<n;)streams[i].sphere()},lineStart:function(){for(var i=-1;++i<n;)streams[i].lineStart()},lineEnd:function(){for(var i=-1;++i<n;)streams[i].lineEnd()},polygonStart:function(){for(var i=-1;++i<n;)streams[i].polygonStart()},polygonEnd:function(){for(var i=-1;++i<n;)streams[i].polygonEnd()}}}function azimuthalRaw(scale){return function(x,y){var cx=
cos(x),cy=cos(y);cx=scale(cx*cy);return Infinity===cx?[2,0]:[cx*cy*sin(x),cx*sin(y)]}}function azimuthalInvert(angle){return function(x,y){var z=sqrt(x*x+y*y),c=angle(z),sc=sin(c);c=cos(c);return[atan2(x*sc,z*c),asin(z&&y*sc/z)]}}function mercatorRaw(lambda,phi){return[lambda,log(tan((halfPi+phi)/2))]}function mercatorProjection(project){function reclip(){var k=pi*scale(),t=m(rotation$jscomp$0(m.rotate()).invert([0,0]));return clipExtent(null==x0?[[t[0]-k,t[1]-k],[t[0]+k,t[1]+k]]:project===mercatorRaw?
